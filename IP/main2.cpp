...
int f2(int x[100], int n) //f2 = 1*x[n]+2*x[n-1]+3*x[n-2]+…+n*x[1];
{
    int i=1;
    int nr=0;
    for(i=1; i<=n; i++)
...
int main()
{
    ...
    std::cout<<"Introduceti nr elemente pentru primul vector (x) "<<'\n';
    //Se va folosi in toate problemele
    citire(a, n);
    std::cout<<"Introduceti nr elemente pentru al doilea vector (y) "<<'\n';
    //Se va folosi in problemele ce necesita ca date de intrare si un al doilea vector
    citire(b, n);
    std::cout<<"Introduceti nr elemente pentru al treilea vector (z) "<<'\n';
    //Se va folosi la problema 5.
    citire(d, n);
    copiere(a, s, n); //creeaza o copie pentru vectorul a
    std::cout<<"Rezultatul pentru 2 a): "<<f1(a, n)<<'\n';
    std::cout<<"Rezultatul pentru 2 b): "<<f2(a, n)<<'\n';
    std::cout<<"Rezultatul pentru 2 c): "<<f3(a, n)<<'\n';
    std::cout<<"Rezultatul pentru 3 a): "<<f4(a, b, n)<<'\n';
    std::cout<<"Rezultatul pentru 3 b): "<<f5(a, b, n)<<'\n';
    std::cout<<"Rezultatul pentru 3 c): "<<f6(a, b, n)<<'\n';
    ...
    f9(a, b, c, n); std::cout<<'\n';
    std::cout<<"Rezultatul pentru 5 a): ";
    if(!f10(a, b, d, n))
        std::cout<<"false"<<'\n';
    else
        std::cout<<"true"<<'\n';
    std::cout<<"Rezultatul pentru 5 b): ";
    if(!f11(a, b, d, n))
        std::cout<<"false"<<'\n';
    else
        std::cout<<"true"<<'\n';
    std::cout<<"Rezultatul pentru 5 c): ";
    if(!f12(a, b, d, n))
        std::cout<<"false"<<'\n';
    else
        std::cout<<"true"<<'\n';
    std::cout<<"Rezultatul pentru 6 a): "<<f13(a, n)<<'\n';
    std::cout<<"Rezultatul pentru 6 b): "<<f14(a, n)<<'\n';
    std::cout<<"rezultatul pentru 6 c): "<<f15(a, n)<<'\n';
    ...
    f21(a, n); std::cout<<'\n';
    copiere(s, a, n);
    std::cout<<"Rezultatul pentru 9 a): ";
    f22(a, n); std::cout<<'\n';
    copiere(s, a, n);
    std::cout<<"Rezultatul pentru 9 b): ";
    f23(a, n); std::cout<<'\n';
    copiere(s, a, n);
    std::cout<<"Rezultatul pentru 9 c): ";
    f24(a, n); std::cout<<'\n';
    copiere(s, a, n);
    std::cout<<"Rezultatul pentru 10 a): "<<f25(a, n)<<'\n';
    std::cout<<"Rezultatul pentru 10 b): "<<f26(a, n)<<'\n';
    std::cout<<"Rezultatul pentru 10 c): "<<f27(a, n)<<'\n';
    std::cout<<"Rezultatul pentru 11 a): "<<f28(a, n)<<'\n';
    std::cout<<"Rezultatul pentru 11 b): "<<f29(a, n)<<'\n';
    std::cout<<"Rezultatul pentru 11 c): "<<f30(a, n)<<'\n';
    return 0;
}
