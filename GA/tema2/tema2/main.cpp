					  ...
					  if(nr==2)
					   {
						   ...
						   for(j=pctrandom;j<dim*superior(a,b);j++)
							{
	...
	for(i=0;i<nrcrom;i++)
	{
		for(j=0;j<dim*superior(a,b);j++)
		  ...
		  TransfBaza10(transformare,dim*superior(a,b),a,b,x,dim);
